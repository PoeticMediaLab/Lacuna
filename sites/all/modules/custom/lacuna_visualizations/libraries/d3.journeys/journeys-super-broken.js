	...
	for (var i = 0; i < json.length; i++) {
		console.log(i);
		 ...
		 // capacity, I'll take them out.
		  ...
		  // title is name and name is title. Blame drupal.
...
//		  console.log(node.name);
	...
	} // end for (var i = 0; i < json.length; i++) 
	...
	// 				3. add to visitedByUseronly those nodes where an item k in
	// 				uniqueNodes[j].visitList.userName[k] matches userNamesColors[i][0]
