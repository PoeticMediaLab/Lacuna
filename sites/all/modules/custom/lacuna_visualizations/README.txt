...
This is a version of the d3.js module, with the force directed diagram
hacked to serve as a prototype for the maps visualization. 
-TODO: move journeys visualization into here
-TODO: rename the visualizations to reflect what they actually are
-TODO: remove the old examples that I used as a base. 

KEY FILES:
d3.css (contains all css associated w/ maps visualization)
libraries/d3.forcedirected/forcedirected.js (contains the d3 that defines the map visualization)
modules/lacuna_visualizations/lacuna_visualizations.module (gets data from EntityFieldQuery, initializes the map visualization w/ it)
d3.tpl.php
default visualization template 
