...
(function() {
  var $, ANNOTATION_CLASS, ANNOTATION_DATA_KEY, ANNOTATION_ID_CLASS_PREFIX, ANNOTATION_LAYER_CLASS, ANNOTATION_LAYER_MARKUP, ANNOTATION_MARKUP, NEW_ANNOTATION_CLASS,
  ...
  Annotator.Plugin.PDF = (function(superClass) {
      ...
      return this.annotations.forEach((function(_this) {
        return function(annotation) {
          ...
          if (annotation.pdfRange && annotation.pdfRange.pageNumber === pageNumber) {
            ...
            _this.linkAnnotationToElement($annotationElement, annotation);
    ...
    PDF.prototype.linkAnnotationToElement = function($annotationElement, annotation) {
    ...
    PDF.prototype.editNewAnnotation = function(pdfRange, $newAnnotationElement) {
      ...
      save = (function(_this) {
        return function() {
          ...
          _this.linkAnnotationToElement($newAnnotationElement, annotation);
    ...
    PDF.prototype.getAnnotationsAtMouseLocation = function(event) {
      ...
      while (true) {
        ...
        if (element.classList.contains(ANNOTATION_CLASS)) {
