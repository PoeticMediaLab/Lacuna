...
(function() {
  ...
  Annotator.Plugin.Histogram = (function(superClass) {
    ...
    Histogram.prototype.countAnnotation = function(annotation) {
      ...
      if (indexOf.call(this.counted, id) < 0 && !annotation.classList.contains(this.selector.hidden)) {
    ...
    Histogram.prototype.assignBarsPerNode = function(node, length) {
      var annotation, child, j, k, len, len1, ref, ref1, totalBars;
      if (length == null) {
        length = 0;
      }
      this.counted = [];
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        if (child.nodeType === Node.ELEMENT_NODE && child.classList.contains(this.selector.annotation)) {
          ...
          if (child.hasChildNodes()) {
            ref1 = child.querySelectorAll('.' + this.selector.annotation);
