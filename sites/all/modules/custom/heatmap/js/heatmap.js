(function ($) {
    ...
    var height = 50,
        ...
        articleNode = pageContainer.iterateNext(), //article node = node where content starts
        ...
        currentNode = articleNode.childNodes[0], //starts with the first child of the article
        lCount = 0, //represents how much text has been included so far, initialized to 0
        anCount = 0; //represents the number of annotations included so far, initialized to 0
